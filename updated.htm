...
<head>
    <title>IOT592W-SDQ 24/5 | MyQMUL</title>
    <link rel="shortcut icon" href="//qmplus.qmul.ac.uk/pluginfile.php/1/theme_catawesome/favicon/1729026699/favicon.ico" />
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="moodle, IOT592W-SDQ 24/5 | MyQMUL" />
<link rel="stylesheet" type="text/css" href="https://qmplus.qmul.ac.uk/theme/yui_combo.php?rollup/3.18.1/yui-moodlesimple-min.css" /><script id="firstthemesheet" type="text/css">/** Required in order to fix style inclusion problems in IE with YUI **/</script><link rel="stylesheet" type="text/css" href="https://qmplus.qmul.ac.uk/theme/styles.php/catawesome/1729026699_1729024339/all" />
<script>
//<![CDATA[
var M = {}; M.yui = {};
M.pageloadstarttime = new Date();
M.cfg = {"wwwroot":"https:\/\/qmplus.qmul.ac.uk","homeurl":{},"sesskey":"dn3tpCADqd","sessiontimeout":"7200","sessiontimeoutwarning":1200,"themerev":"1729026699","slasharguments":1,"theme":"catawesome","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1729024113","admin":"admin","svgicons":true,"usertimezone":"Europe\/London","language":"en","courseId":25954,"courseContextId":4293114,"contextid":4216332,"contextInstanceId":1203,"langrev":1729024113,"templaterev":"1729024113"};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<body  id="page-enrol-index" class="format-qmultopics tabsloading limitedwidth  path-enrol chrome dir-ltr lang-en yui-skin-sam yui3-skin-sam qmplus-qmul-ac-uk pagelayout-incourse course-25954 context-4216332 category-1203 theme uses-drawers hamburger-left custom-header" >
...
<!-- Queen Mary, University of London -->
    ...
    <nav class="fixed-top navbar navbar-expand moodle-has-zindex" aria-label="Site navigation">
        ...
        <a href="https://qmplus.qmul.ac.uk" class="navbar-brand d-flex align-items-center m-0 p-0 aabtn has-logo 
            ">
            <span class="logo">
                <img src="//qmplus.qmul.ac.uk/pluginfile.php/1/theme_catawesome/logo/1729026699/qm-logo-white.svg" alt="MyQMUL">
            </span>
        ...
        <ul class="navbar-nav d-none d-md-flex">
            ...
            <li class="primary-navigation">
                <nav class="moremenu navigation">
                    <ul id="moremenu-67153f916fa19-navbar-nav" role="menubar" class="nav more-nav navbar-nav">
                                ...
                                <li class="dropdown nav-item" role="none" data-forceintomoremenu="false">
                                    <a class="dropdown-toggle nav-link  " id="drop-down-67153f916f98c" role="menuitem" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false" href="#" aria-controls="drop-down-menu-67153f916f98c"
                                    ...
                                    <div class="dropdown-menu" role="menu" id="drop-down-menu-67153f916f98c" aria-labelledby="drop-down-67153f916f98c">
                        ...
                        <li role="none" class="nav-item dropdown dropdownmoremenu d-none" data-region="morebutton">
                            <a class="dropdown-toggle nav-link " href="#" id="moremenu-dropdown-67153f916fa19" role="menuitem" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" tabindex="-1">
                                More
                            </a>
                            <ul class="dropdown-menu dropdown-menu-left" data-region="moredropdown" aria-labelledby="moremenu-dropdown-67153f916fa19" role="menu">
                            </ul>
                        </li>
                    </ul>
                </nav>
        ...
        <div id="usernavigation" class="navbar-nav ml-auto">
            <div id="searchinput-navbar-67153f91710b867153f91702b22" class="simplesearchform">
    <div class="collapse" id="searchform-navbar">
        <form autocomplete="off" action="https://qmplus.qmul.ac.uk/search/index.php" method="get" accept-charset="utf-8" class="mform form-inline searchform-navbar">
                <input type="hidden" name="context" value="4216332">
            <div class="input-group">
                <label for="searchinput-67153f91710b867153f91702b22">
                    <span class="sr-only">Search</span>
                </label>
                    <input type="text"
                       id="searchinput-67153f91710b867153f91702b22"
    ...
    <ol class="breadcrumb"></ol>
        ...
        <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <div class="page-context-header"><div class="page-header-headings"><h1 class="h2">IOT592W Solutions Development and Quality 2024/25</h1></div></div>
                    </div>
            ...
            <div id="page-content" class="pb-6 d-print-block">
                <div id="region-main-box">
                    <section id="region-main" aria-label="Content">
                        ...
                        <div role="main"><span id="maincontent"></span><h2>Enrolment options</h2><div class="box py-3 generalbox info"><div class="coursebox clearfix" data-courseid="25954" data-type="1"><div class="info"><h3 class="coursename"><a class="" href="https://qmplus.qmul.ac.uk/course/view.php?id=25954">IOT592W Solutions Development and Quality 2024/25</a></h3><div class="moreinfo"></div></div><div class="content"></div></div></div><div id="notice" class="box py-3 generalbox">Guests cannot access this course. Please log in.</div><div class="continuebutton">
    <form method="get" action="https://qmplus.qmul.ac.uk/login/index.php" >
        <button type="submit" class="btn btn-primary"
            id="single_button67153f91702b24"
        ...
        <footer id="page-footer" data-region="mainpage" class="bg-inverse">
            ...
            <div class="footer-content-popover container" data-region="footer-content-popover">
                <div class="footer-section p-3 border-bottom">
                    ...
                    <a class="mobilelink" href="https://download.moodle.org/mobile?version=2023100908&amp;lang=en&amp;iosappid=633359593&amp;androidappid=com.moodle.moodlemobile">Get the mobile app</a>
...
M.util.js_pending('local_bfnewwindow/bfnewwindow'); require(['local_bfnewwindow/bfnewwindow'], function(amd) {amd.initialise("25954", "2023100908"); M.util.js_complete('local_bfnewwindow/bfnewwindow');});;

    require(['core/moremenu'], function(moremenu) {
        moremenu(document.querySelector('#moremenu-67153f916fa19-navbar-nav'));
    });
;
...
function(
    ...
    var uniqid = "67153f91710b867153f91702b22";
...
;
M.util.js_pending('core/notification'); require(['core/notification'], function(amd) {amd.init(4216332, []); M.util.js_complete('core/notification');});;
...
<script src="https://qmplus.qmul.ac.uk/theme/javascript.php/catawesome/1729026699/footer"></script>
<script>
//<![CDATA[
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random67153f91702b25'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random67153f91702b25'); });
})();
//]]>
</script>
  ...
  <li><a href="https://2019.qmplus.qmul.ac.uk/">2019/20</a></li>
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-67153f91724a367153f91702b23" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-67153f91724a367153f91702b23">
        Help
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-67153f91724a367153f91702b23" aria-labelledby="drop-down-67153f91724a367153f91702b23">
        ...
        <nav class="list-group" aria-label="Site">
            <ul class="metismenu">
                    ...
                    <ul class="metismenu">
                        ...
                        <li class="nav-item">
                            <a class="list-group-item list-group-item-action nav-link  " href="https://qmplus.qmul.ac.uk/calendar/view.php?view=month&amp;course=25954" data-key="calendar" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="60" data-nodetype="0" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="1" data-toggle="tooltip" data-placement="right"
                            title="Calendar">
                                <div class="ml-0">
                                    <div class="media">
                                            <span class="media-left">
